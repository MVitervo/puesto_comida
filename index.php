...
<body class="bg-white text-slate-800 dark:bg-gray-900 dark:text-slate-200 transition-colors duration-300">
    <div class="flex h-screen w-full">
        ...
        <aside id="sidebar"
            ...
            <!-- HEADER -->
            <div class="h-16 flex items-center justify-between px-4 border-b border-slate-700 dark:border-slate-500">
            ...
            <div class="flex-1 overflow-y-auto p-3 space-y-4">
                ...
                <div class="space-y-1">
                    ...
                    <a onclick="sidebarOption('listPatients')" class="menu-item group relative flex items-center gap-3 px-4 py-2 rounded-lg transition-all duration-300 hover:bg-indigo-600/80 dark:hover:text-slate hover:scale-[1.03] hover:pl-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                        </svg>
                        <span class="sidebar-text font-medium transition-all duration-300 opacity-100 translate-x-0">Listado de personas</span>
                    </a>

                    <a onclick="sidebarOption('calendar')" class="menu-item group relative flex items-center gap-3 px-4 py-2 rounded-lg transition-all duration-300 hover:bg-indigo-600/80 hover:text-white hover:scale-[1.03] hover:pl-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <a onclick="sidebarOption('graphics')" class="menu-item group relative flex items-center gap-3 px-4 py-2 rounded-lg transition-all duration-300 hover:bg-indigo-600/80 hover:text-white hover:scale-[1.03] hover:pl-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
                        </svg>

                        <span class="sidebar-text font-medium">Gráficas</span>
                    </a>
